...
import com.actions.bluetoothbox.fragment.LightFragment;
...
public class BrowserActivity extends BaseActivity implements OnAudioFocusChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//隐藏音量
		mGlobalInfoLayout.setVisibility(View.GONE);
				...
				public void onReady() {
					...
					mBluzManager.setOnGlobalUIChangedListener(new OnGlobalUIChangedListener() {
						...
						public void onModeChanged(int mode) {
							...
							switch (mode) {
							//不要A2DP使用BluetoothLightCommond.FuncMode.LIGHT
//							case FuncMode.A2DP:
//								if (mA2DPMusicFragment == null) {
...
//								break;
							...
							case BluetoothLightCommond.FuncMode.LIGHT:
								newContentFragment = new LightFragment();
